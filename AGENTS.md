...
- Цели пользователя/команды: Собрать и проверить качество локальной транскрибации двухканальных аудиозаписей (русский язык) с последующей интеллектуальной обработкой (суммаризация, оценка качества оператора, извлечение данных). При успехе — масштабировать на продакшн-сервер (50+ одновременных звонков).

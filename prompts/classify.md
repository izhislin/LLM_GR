...
- "продажи/предложение" — исходящие звонки с предложением услуг, коммерческие предложения, реклама, привлечение клиентов
- "жалоба" — жалоба на качество обслуживания или сервис
- "клиентский_бизнес" — звонок НЕ относится к телефонии/ВАТС, а касается бизнеса клиента (заявки от их конечных потребителей: ремонт, сервис, доставка, запись и т.п.)
...
- Для "продажи/предложение": "холодный звонок", "допродажа", "партнёрское предложение", "информирование об акции"
- Для "клиентский_бизнес": "заявка на сервис", "запись на приём", "доставка", "рекламация", "входящий от потребителя"
